...
final class Title
{
    ...
    public static function fromApiResponse(array $data): self
    {
        return new self(
            ...
            editionNo: isset($data['EditionNo']) && $data['EditionNo'] !== '' ? (int) $data['EditionNo'] : null,
            ...
            ageFrom: isset($data['AgeFrom']) && $data['AgeFrom'] !== '' ? (int) $data['AgeFrom'] : null,
            ageTo: isset($data['AgeTo']) && $data['AgeTo'] !== '' ? (int) $data['AgeTo'] : null,
            ...
            volumeCount: isset($data['VolumeCount']) && $data['VolumeCount'] !== '' ? (int) $data['VolumeCount'] : null,
